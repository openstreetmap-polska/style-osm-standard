...
<qgis maxScale="0" version="3.8.0-Zanzibar" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyDrawingTol="1" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyMaxScale="1" readOnly="0" simplifyLocal="1">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{7af5b1bb-29b1-48cf-9263-038a05265f01}">
      ...
      <rule label="farm" key="{1f728b34-0ab9-4c3f-b820-f287f1e3695e}" symbol="2" filter="&quot;fclass&quot; = 'farm'" checkstate="0"/>
      <rule label="grass" key="{f39cae5e-9507-4c39-a1ea-5f3b3c181be8}" symbol="3" filter="&quot;fclass&quot; = 'grass'" checkstate="0"/>
      <rule label="heath" key="{d55f70fd-ea3e-409f-9b40-fc95d11c4806}" symbol="4" filter="&quot;fclass&quot; = 'heath'" checkstate="0"/>
      <rule label="meadow" key="{8dd4a8c5-0604-484c-afa3-e95198f4be29}" symbol="5" filter="&quot;fclass&quot; = 'meadow'" checkstate="0"/>
      <rule label="military" key="{de5c8731-a0fc-48c6-8bdc-474d474f6d5b}" symbol="6" filter="&quot;fclass&quot; = 'military'" checkstate="0"/>
      <rule label="nature_reserve" key="{f475d2eb-17c3-4298-8445-4c142e7dac6a}" symbol="7" filter="&quot;fclass&quot; = 'nature_reserve'" checkstate="0"/>
      <rule label="orchard" key="{c4281427-d989-493e-a24f-5ae9eaec5f71}" symbol="8" filter="&quot;fclass&quot; = 'orchard'" checkstate="0"/>
      <rule label="quarry" key="{4b8c7a22-4d8e-46c6-b137-81af936dace1}" symbol="9" filter="&quot;fclass&quot; = 'quarry'" checkstate="0"/>
      <rule label="recreation_ground" key="{29c1863c-f0cd-4030-b60c-7f607fb4754a}" symbol="10" filter="&quot;fclass&quot; = 'recreation_ground'" checkstate="0"/>
      <rule label="scrub" key="{9708d136-09f6-4dbe-b40b-7e7a6d6bf983}" symbol="11" filter="&quot;fclass&quot; = 'scrub'" checkstate="0"/>
      <rule scalemindenom="1000" label="forest" scalemaxdenom="5000000" key="{01fe0435-2da6-4549-9792-2f9301a97814}" symbol="12" filter="&quot;fclass&quot; = 'forest'"/>
      <rule scalemindenom="1000" label="park" scalemaxdenom="500000" key="{cbdfc31d-16fa-45d2-8366-bd436e803ab8}" symbol="13" filter="&quot;fclass&quot; = 'park'"/>
      <rule label="commercial" key="{86d36b09-7cd5-4533-8c32-c626fa1d6ac6}" symbol="14" filter="&quot;fclass&quot; = 'commercial'">
        <rule scalemindenom="1000" label="1000 - 8000" scalemaxdenom="8000" key="{d1bb9230-4663-40c9-ae8c-96a1219fd860}" symbol="15"/>
        <rule scalemindenom="8000" label="8000 - 70000" scalemaxdenom="70000" key="{3f250775-6bb5-4eb0-b11f-bf7b562522d5}" symbol="16"/>
        <rule scalemindenom="70000" label="70000 - 150000" scalemaxdenom="150000" key="{2a9983c8-c69e-450e-a865-d061918c928c}" symbol="17"/>
        <rule scalemindenom="150000" label="150000 - 250000" scalemaxdenom="250000" key="{45df22c7-dc26-4f8c-834d-e45283c53c31}" symbol="18"/>
      </rule>
      <rule label="industrial" key="{e6816ec1-4053-451e-b794-42b7cb3dd632}" symbol="19" filter="&quot;fclass&quot; = 'industrial'">
        <rule scalemindenom="1000" label="1000 - 8000" scalemaxdenom="8000" key="{4bfb9dbb-bed1-4b54-9073-b76c0812d0a9}" symbol="20"/>
        <rule scalemindenom="8000" label="8000 - 70000" scalemaxdenom="70000" key="{6fd59645-cc56-4216-9d8b-5c7f352ff247}" symbol="21"/>
        <rule scalemindenom="70000" label="70000 - 150000" scalemaxdenom="150000" key="{94830b5b-0bae-47c8-b707-0d09f088a12b}" symbol="22"/>
        <rule scalemindenom="150000" label="150000 - 250000" scalemaxdenom="250000" key="{32702bc4-6d85-4358-87aa-7a9673e49786}" symbol="23"/>
      </rule>
      <rule label="retail" key="{c95cbf22-5a62-4622-8ca1-6ef02d3be531}" symbol="24" filter="&quot;fclass&quot; = 'retail'">
        <rule scalemindenom="1000" label="1000 - 8000" scalemaxdenom="8000" key="{92da5315-acf3-4f79-95ed-a19784a0c915}" symbol="25"/>
        <rule scalemindenom="8000" label="8000 - 70000" scalemaxdenom="70000" key="{724f9661-02bd-40bd-91cf-d4e7b294f8f8}" symbol="26"/>
        <rule scalemindenom="70000" label="70000 - 150000" scalemaxdenom="150000" key="{f40d3369-9c38-417b-a6af-11ceae2d664d}" symbol="27"/>
        <rule scalemindenom="150000" label="150000 - 250000" scalemaxdenom="250000" key="{b82ed1dc-20dd-46bb-9bd6-7a46f3a01ed5}" symbol="28"/>
      </rule>
      <rule scalemindenom="1000" label="residential" scalemaxdenom="250000" key="{d049e556-9c89-4850-8998-a7645bac1b5b}" symbol="29" filter="&quot;fclass&quot; = 'residential'">
        <rule scalemindenom="1000" label="1000 - 8000" scalemaxdenom="8000" key="{f3d93c69-2fae-43fb-8038-d2433bb5db5a}" symbol="30"/>
        <rule scalemindenom="8000" label="8000 - 70000" scalemaxdenom="70000" key="{544715d0-187d-4f6f-9eda-b08f2d859a31}" symbol="31"/>
        <rule scalemindenom="70000" label="70000 - 150000" scalemaxdenom="150000" key="{cab64171-fad8-4b97-b391-df650148c5a7}" symbol="32"/>
        <rule scalemindenom="150000" label="150000 - 250000" scalemaxdenom="250000" key="{b2186f03-80c4-44fd-9746-417e6d5b10a8}" symbol="33"/>
      </rule>
      <rule scalemindenom="250000" label="built-up" scalemaxdenom="2000000" key="{444f3e71-05e7-4d9d-b64c-e23d8f23b0cf}" symbol="34" filter=" &quot;fclass&quot; IN( 'commercial' , 'industrial' , 'retail' , 'residential')"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" name="31" clip_to_extent="1" alpha="1" type="fill">
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="224,223,223,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
      ...
      <symbol force_rhr="0" name="32" clip_to_extent="1" alpha="1" type="fill">
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="208,208,208,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
      ...
      <symbol force_rhr="0" name="33" clip_to_extent="1" alpha="1" type="fill">
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="192,192,192,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
      ...
      <symbol force_rhr="0" name="34" clip_to_extent="1" alpha="1" type="fill">
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
