...
<qgis labelsEnabled="1" hasScaleBasedVisibilityFlag="0" minScale="1e+8" version="3.8.1-Zanzibar" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" readOnly="0" simplifyLocal="1" simplifyDrawingHints="0" maxScale="0" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{7b5ae244-019e-43f3-9e7e-84bda933f248}">
      <rule symbol="0" label="beach" key="{ccca6513-b024-417f-91d8-c318d141c249}" checkstate="0" filter="&quot;fclass&quot; = 'beach'"/>
      <rule symbol="1" scalemaxdenom="15000" label="cave_entrance" key="{bd7d528a-299c-4ccf-9ee1-6c9560581e90}" filter="&quot;fclass&quot; = 'cave_entrance'" scalemindenom="1"/>
      <rule symbol="2" label="cliff" key="{b4d5c590-0864-44a3-bce4-5dc99408e1e5}" filter="&quot;fclass&quot; = 'cliff'"/>
      <rule symbol="3" label="peak" key="{c6a12b6f-a841-4ad4-b888-ed9eb16897b1}" filter="&quot;fclass&quot; = 'peak'"/>
      <rule symbol="4" label="spring" key="{4e932f79-1354-4c6e-91af-513fab0956f0}" filter="&quot;fclass&quot; = 'spring'"/>
      <rule symbol="5" label="tree" key="{5c13fe3a-0710-4835-9ca7-fcebc915c59d}" filter="&quot;fclass&quot; = 'tree'"/>
      <rule symbol="6" key="{97ba1fc9-81b8-4596-a552-99ef55e55375}" filter="&quot;fclass&quot; = 'glacier'"/>
      <rule symbol="7" key="{10089609-d771-4fe6-89a1-3186d7318b00}" filter="&quot;fclass&quot; = 'mine'"/>
      <rule symbol="8" key="{ac1e73ef-64c0-4b21-9908-8f45ea3e1c3a}" filter="&quot;fclass&quot; = 'volcano'"/>
      <rule symbol="9" key="{8a983ec7-6514-4d7b-84e7-0524640758e7}" filter="ELSE"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{229beb6d-109f-41b9-ad79-f3bc1b5225d6}">
      <rule scalemaxdenom="15000" key="{f644f8f9-cbb5-47ae-bf72-2c784938be49}" scalemindenom="1">
        <settings>
